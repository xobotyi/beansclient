...
class JobOld
{
     ...
     * Job constructor.
     *
     * @param \xobotyi\beansclient\BeansClientOld $beansClient
     * @param int                                 $id
     * @param mixed                               $state
     * @param mixed                               $payload
     *
     ...
     */
    public
    function __construct(BeansClientOld &$beansClient, ?int $id, ?string $state = null, $payload = null) {
    ...
    /**
     * @return \xobotyi\beansclient\JobOld
     * @throws \xobotyi\beansclient\Exception\ClientException
     * @throws \xobotyi\beansclient\Exception\CommandException
     * @throws \xobotyi\beansclient\Exception\JobException
     */
     ...
     */
    public
    function bury(int $priority = BeansClientOld::DEFAULT_PRIORITY): self {
        if (!$this->data['id']) {
            return $this;
        }
    ...
    /**
     * @return \xobotyi\beansclient\BeansClientOld
     */
    public
    function getClient(): BeansClientOld {
        return $this->client;
    }
     ...
     */
    public
    function setClient(BeansClientOld &$beansClient) {
